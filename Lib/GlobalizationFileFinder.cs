...
namespace Andoromeda.Kyubey.Incubator.Lib
{
    public static class GlobalizationFileFinder
    {
        ...
        public static string GetFileId(string filePath)
        {
            return Path.GetFileNameWithoutExtension(filePath)
                         .RemoveEnd(FileCultureFileSuffix.EN)
                         .RemoveEnd(FileCultureFileSuffix.JP)
                         .RemoveEnd(FileCultureFileSuffix.ZHCN)
                         .RemoveEnd(FileCultureFileSuffix.ZHTW);
        }
